...
@Component({
  selector: 'app-user-header-common',
  animations: [fadeInAnimation
  ],
  templateUrl: './user-header-common.component.html',
  styleUrls: ['./user-header-common.component.scss']
})
export class UserHeaderCommonComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.questionModal = $("#addQuestionModalCommon");
