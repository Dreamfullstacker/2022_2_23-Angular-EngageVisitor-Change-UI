...
export class AppConst {
    ...
    public static APPLICATION_NAME = "Engage Visitor";
    public static COMPANY_URL = "https://engagevisitor.com/";
    public static COMPANY_NAME = "Engage Visitor";

    public static HAPPY_INDEX = 7;
    public static UNHAPPY_INDEX = 4;
    ...
    public static QUESTION_TYPE_LIST: any = [
        {
            "id": 1,
            "type": "short_text",
            "title":  "&#8633; ",
            "display": "Short Answer",
            "tooltip":`For responses like Names`
        ...
        },
        {
            ...
            "title": "&#8644;",
            "display": "Long Answer",
            "tooltip":`For responses that are longer`
        },
        {
            "id": 3,
            "type": "drop_down",
            "title": "&#9660;",
            "display": "Drop Down",
            "tooltip":"Provide dropdown menu selection"
        },
        {
            "id": 4,
            "type": "check_box",
        ...
        },
        {
            ...
            "tooltip":"Allow selection of only one option"
        }
        ,
        {
            "id": 6,
            ...
            "tooltip":"Collect a valid email address"
        },
        {
            "id": 7,
            "type": "number",
            "title": " &#3177;",
            "display": "Number",
            "tooltip":"Allow number input, but not text"
        },
        {
            "id": 8,
            "type": "phone_number",
            ...
            "tooltip":"Collect phone number with country code"
        },
        {
            "id": 9,
            "type": "rating",
            "title": "&#9733;",
            "display": "Rating",
            "tooltip":"Get a rating"
        },
        {
            "id": 10,
            "type": "nps",
            "title": "&#128076;",
            "display": "Net Promotor Score",
            "tooltip":"Collect NPS"
        },
        {
            "id": 11,
            "type": "Country",
            "title": " &#9872;",
            "display": "Choose Your Country",
            "tooltip":"Dropdown of country names"
        },
        {
            "id": 12,
            "type": "Statement",
            ...
            "tooltip":"Add text/statement that doesn’t seek a response"
        },
        {
            "id": 13,
            "type": "Date",
            "title": " &#128197;",
            "display": "Select Date",
            "tooltip":"Date selection from calendar"
        }
    ];

    public static FORM_VISIBILITY_STATUS = {
        STATUS_PUBLISH: "1",
        STATUS_UNPUBLISH: "0"
    }
